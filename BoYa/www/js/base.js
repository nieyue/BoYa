...
var myUtils = {
	...
	myPrevToast : function(value,fn,motion) {
		...
		$("body")
				.append(
						"<div id='prevToastWarp' style='z-index:999999;display:none;position:fixed;width:100%;height:100%;top:0;left:0;'><div id='prevToast' style='z-index:999999;color:#fff;background-color:#000;text-align:center;line-height:30px;border:1px solid black;border-radius:5px;min-height:30px;width:100px;margin:-15px -50px;top:50%;left:50%;position:fixed;'><canvas id='prevloading'  height='30px' width='30px' style='z-index:999999;display:inline-block;margin-bottom:-10px;' >您的浏览器不支持html5</canvas>"
						+"<span id='prevToastValue' class='z-index:999999;'>"+ value +"</span>&nbsp;&nbsp; </div></div>");
		if(typeof fn=='function'){
			fn();
		}
	},
	...
	myLoadingToast : function(value, fn) {
		...
		$("body")
				.append(
						"<div id='loadingToast' style='display:none;color:#fff;background-color:black;text-align:center;line-height:30px;border:1px solid black;border-radius:5px;min-height:30px;max-width:200px;padding:0 10px;margin:-5px -"+value.length*7+"px;top:50%;left:50%;position:fixed;z-index:999999;'>"
						+ value + "</div>");
		$("#loadingToast").fadeIn();
		setTimeout(function() {
	...
	myConfirm : function(value,fn) {
		$("body")
		.append(
				"<div id='confirmDiv' style='z-index:999999;position:fixed;width:100%;height:100%;background-color:#fff;opacity:0.5;left:0;top:0;'></div><div id='confirm' style='z-index:999999;color:#fff;background-color:black;text-align:center;line-height:30px;border:1px solid black;border-radius:5px;height:200px;width:200px;margin:-100px -100px;top:50%;left:50%;position:fixed;font-size:20px;'>"
				+ "<div class='ion-close-circled' style='color:red;width:50%;height:50%;font-size:88px;margin:5px 25% 0 25%;'></div><div style='position:absolute;top:88px;width:100%;text-align:center;'>"+value+"</div><div class='button button-balanced' style='position:absolute;left:0;bottom:0;width:50%;' id='confirmYes'>确定</div><div class='button button-light' style='position:absolute;right:0;bottom:0;width:50%;' id='confirmNo'>取消</div></div>");
	...
	myLoginOut : function(value,fn) {
		$("body")
		.append(
				"<div id='confirmDiv' style='z-index:999999;position:fixed;width:100%;height:100%;background-color:#ccc;opacity:0.5;left:0;top:0;'></div><div id='confirm' style='z-index:999999;color:#fff;background-color:black;text-align:center;line-height:30px;border:1px solid black;border-radius:5px;height:200px;width:200px;margin:-100px -100px;top:50%;left:50%;position:fixed;font-size:20px;'>"
